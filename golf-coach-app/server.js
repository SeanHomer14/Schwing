...
function localCoachReply({ question = "", clubs = [], profile = {}, memories = [], context = {} }) {
...
async function callOpenAI(payload) {
  ...
  return extractResponseText(data) || "I could not produce a coach response. Try adding the yardage, lie, wind, and intended target.";
}
...
server.listen(port, host, () => {
  console.log(`Loop Golf Coach running at http://${host}:${port}/`);
});
